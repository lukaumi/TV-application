        ...
        while (j < eit->eventInformation[eit->eventInformationCount - 1].descriptorsLoopLength) {
            ...
            if (tempDescriptorTag == SHORT_EVENT_DESCRIPTOR_TAG) {
                ...
                for (k = 0; k < eit->eventInformation[eit->eventInformationCount - 1].eventNameLength; k++) {
                    if ( *(buffer + 14 + i + 6 + j + k + 1) < 0 || *(buffer + 14 + i + 6 + j + k + 1) > 127 ) eit->eventInformation[eit->eventInformationCount - 1].eventNameChar[k] = ' ';
                    else eit->eventInformation[eit->eventInformationCount - 1].eventNameChar[k] = *(buffer + 14 + i + 6 + j + k + 1);
                }
                ...
                for (k = 0; k < eit->eventInformation[eit->eventInformationCount - 1].textLength; k++) {
                    if ( *(buffer + 14 + i + 6 + eit->eventInformation[eit->eventInformationCount - 1].eventNameLength + 1 + j + k + 1) < 0 ||
                         *(buffer + 14 + i + 6 + eit->eventInformation[eit->eventInformationCount - 1].eventNameLength + 1 + j + k + 1) > 127 ) eit->eventInformation[eit->eventInformationCount - 1].textChar[k] = ' ';
                    else eit->eventInformation[eit->eventInformationCount - 1].textChar[k] = *(buffer + 14 + i + 6 + eit->eventInformation[eit->eventInformationCount - 1].eventNameLength + 1 + j + k + 1);
                }
